...
return [
    ...
    'description' => 'REST API for the Commission Calculator — manage contracts, formulas, and commission calculations.',
    ...
    'base_url' => 'https://commission-engine.cms-it-experts.com',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate by calling <b>POST /api/login</b> and passing the returned token as a Bearer token in the Authorization header.',
    ],
